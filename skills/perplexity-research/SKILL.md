...
Also available via `references/academic-verify.md` — a thin orchestrator
that wraps perplexity-research for citation-verified academic claim
checking. Traces claims through publication → methodology → raw data →
independent replication. Routes through this skill for the actual web
lookup, then formats results as a verdict-shaped brain page.
...
- `references/academic-verify.md` (in this skill) — wraps perplexity-research for
