...
## Format-Specific Ingestion Handbooks

This skill is the router. For detailed format-specific workflows, see the reference files below.
They live under `references/` in this skill's directory and cover the full pipeline
(fetching, entity extraction, back-linking, raw source preservation) for each input type.

| Format | Reference |
|--------|-----------|
| Links, articles, tweets, ideas | `references/idea-ingest.md` — author people-page enforcement, analysis for the user |
| Video, audio, PDF, book, screenshot, GitHub repo | `references/media-ingest.md` — transcript handling, OCR, multi-format |
| Meeting transcripts | `references/meeting-ingestion.md` — attendee enrichment, action items, timeline merge |
| Voice notes / audio messages | `references/voice-note-ingest.md` — exact-phrasing preservation, decision tree routing |
| Article enrichment (post-ingest) | `references/article-enrichment.md` — from raw dumps to structured pages |
| Filing rules (where things go) | `references/repo-architecture.md` — decision protocol for page placement |

### Quick format detection

| Input type | Route to |
|-----------|----------|
| URL / link | `references/idea-ingest.md` |
| YouTube link / video file | `references/media-ingest.md` |
| PDF / book | `references/media-ingest.md` |
| Meeting transcript | `references/meeting-ingestion.md` |
| Voice memo / audio | `references/voice-note-ingest.md` |
| Raw article dump | `references/idea-ingest.md` then `references/article-enrichment.md` |

## Phases

> **Router note:** This skill is a router. For format-specific handbooks, see the Format-Specific Ingestion Handbooks section above.
