...
- `skills/ingest/SKILL.md` — umbrella routing skill; see `references/voice-note-ingest.md` for voice-note workflows (same exact-phrasing pattern)
  audio capture
- `skills/ingest/SKILL.md` — umbrella routing skill; see `references/idea-ingest.md` for single-link-or-article ingest with
