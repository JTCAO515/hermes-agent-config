...
Usage:  python3 weixin_send.py < message.txt  (reads from stdin)
        echo "hello" | python3 weixin_send.py

Credentials are read from environment variables (WEIXIN_TOKEN, etc.)
which are set in ~/.hermes/.env and ~/.hermes/config.yaml.
"""
import json, struct, secrets, sys, requests

TOKEN = "8b6a2a6fdcd9@im.bot:06000097f4b38f7b1b86ee9dbe71c802d31212"
