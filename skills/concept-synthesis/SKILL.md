...
- `skills/ingest/SKILL.md` — umbrella routing skill; see `references/voice-note-ingest.md` for voice-note workflows
- `skills/ingest/SKILL.md` — umbrella routing skill; see `references/idea-ingest.md` for link/article workflows
